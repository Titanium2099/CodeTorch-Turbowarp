    ...
    class StateManagerComponent extends React.Component {
        ...
        componentDidMount () {
            ...
            for (const extension of urlParams.getAll('extension')) {
                ...
                // weird put functional way to load unsandboxed extensions
                this.props.vm.extensionManager.loadExtensionURL('https://extensions.turbowarp.org/penplus.js');
                this.props.vm.extensionManager.loadExtensionURL('https://extensions.turbowarp.org/cursor.js');
                this.props.vm.extensionManager.loadExtensionURL('https://extensions.turbowarp.org/runtime-options.js');

                this.props.vm.extensionManager.loadExtensionURL('https://extensions.turbowarp.org/files.js');
                this.props.vm.extensionManager.loadExtensionURL('https://extensions.turbowarp.org/box2d.js');
